...
[![Version: 0.2.0](https://img.shields.io/badge/version-0.2.0-blue.svg)](./docs/CHANGELOG.md)
...
**Текущий: ✅ v0.2.0** — 21 скил + 28 references + 15 std + автоварификатор (validate_skills.py) + CI + тесты. Карточки обезличены, без привязки к конкретным конфигурациям.
